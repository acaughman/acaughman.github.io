...
```{r, fig.cap= "Average SST in the Southern California Bight in 2000 - 2009. Training data is in blue and testing data is in red"}
ggplot() +
...
plot(pre_ts, ylim = range(13:25))
lines(fitted(m1), col = "red")
lines(fitted(m2), col = "green")
lines(fitted(m3), col = "purple")
lines(fitted(m4), col = "blue")
legend(x = 2, y = 25, legend = c("MA", "AR", "ARMA", "Auto-ARIMA"), col = c("red", "green", "purple", "blue"), lty = 1)
```
...
ggplot() +
  ...
  geom_line(data = post_sst, aes(date, forcast1, color = "MA")) +
  geom_line(data = post_sst, aes(date, forcast2, color = "AR")) +
  geom_line(data = post_sst, aes(date, forcast3, color = "ARMA")) +
  geom_line(data = post_sst, aes(date, forcast4, color = "Auto-ARIMA")) +
  theme_bw() +
  labs(x = "Date", 
       y = "SST (°C)") + 
  scale_color_manual(name="Model",
                     breaks=c("MA", "AR", "ARMA", "Auto-ARIMA"),
                     values=c("MA" = "red", "AR" = "green", "ARMA" = "purple", "Auto-ARIMA" = "blue"))
```
